...
<%
		...
		{	
			...
			if(  bbs.getBbsFileName() != null ){
				result = bbsDAO.write(bbs.getBbsTitle(), bbsuserID, bbs.getBbsContent(), bbs.getBbsFileName(), bbs.getBbsCount());
			}
			else 
			{
				result =bbsDAO.write(bbs.getBbsTitle(), bbsuserID, bbs.getBbsContent(), bbs.getBbsCount());
			}
