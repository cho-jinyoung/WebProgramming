...
<a href="main_page.jsp"><h1>YOUR DAY<small>_Rejoin</small></h1></a>
...
<body>
	...
	%>
<form action="rejoin_Action.jsp?userID=<%=userID %>" method="post">
	<div class="container">   
			<div class="row"> 
			<div class="col-md-2"> </div>
				<div class="col-md-8"  style="background-color: #B2CDD2; ">
				<center><h2>Rejoin</h2><br>재가입을 원치 않으시면 '취소'를 눌러주세요</center><br>
				<div class="form-horizontal">
				 ...
				 <div class="form-group">             
					...
					<div class="col-sm-10">          
					<input type="text" class="form-control" name="userPassword" placeholder="Enter Password">
					</div>
					</div>
				...
				<center>
					...
					<a href="login.jsp"><input type="button" class="btn btn-default" value="취소"> </a>
					 <br><br>
         		</center>
		</div>
		</div>
