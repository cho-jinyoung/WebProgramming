	...
	<%
		...
		if(!userID.equals(bbs.getUserID()) )
		{
			...
			else
			{
				...
				int result = bbsDAO.update( request.getParameter("userName"), request.getParameter("userID"), request.getParameter("userPassword"), request.getParameter("phone"), request.getParameter("gender"));
				...
				else 
				{
					PrintWriter script=response.getWriter();
					script.println("<script>");
					script.println("location.href = 'my_account.jsp'");
					script.println("</script>");
				}	
			}
		}
